...
<form style="margin:20px;" action="{{ url('editinfo/update', $pengumuman->id) }}"method="post" enctype="multipart/form-data">
    ...
    {{ method_field('PUT') }}
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
    		...
    		<input type="file" class="custom-file-input" name="file" value="{{$pengumuman->file}}" required>
    		</div>
  			</div>
